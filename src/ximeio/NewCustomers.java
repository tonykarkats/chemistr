...
public class NewCustomers extends JFrame {
    ...
    private void initializeTable() {
        ...
        Vector<String> rowData = new Vector<String>();
            try {
                ...
                ResultSet rs = stmt.executeQuery("select CustomerID,Surname,Name,FatherName,Nickname,Address,Phone1,Phone2,mail,afm,doy from Customer where extract(year from Added)= extract(year from CURDATE()) order by Surname");
                while (rs.next()) {
